...
**1. Question:** Is there a relationship between daylength and antidepressant prescribing in Scotland, and are there differences based on Healthboard?

**2. Approach:** Look at monthly prescribing for SSRI antidepressants between 2022 and 2023. Calculate the daylength for each healthboard from Healthboard centroids for the 15th of each month. Look at the relationship between the two for Scotland as a whole and in each Healthboard.

**Note:** I've only added first code chunk to keep it short
...
**Discussion:** From the plot above there seems to be no pattern between SSRI prescriptions and daylength time for the whole of Scotland.
...
**Further Work:** I will map the winter-summer prescribing differences for each Healthboard, which would give seasonal trends based on latitude. I could also adjust the prescription rate graph to match a hypothetical 1-2 month time lag for prescribing SSRIs following new depression symptoms.
