...
**Further Work:** I will map the winter summer presribing differences for each healthboard, which would give seasonal trends based on latitude. I will also consider adjusting the prescription rate graphs to match a hypothetical time lag for prescribing SSRIs following new depression symptoms.
