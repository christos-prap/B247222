...
**Note:** Several code chunks are missing in between to keep it short
...
**Further Work:** I will map the winter-summer prescribing differences for each healthboard, which would give seasonal trends based on latitude. I could also adjust the prescription rate graph to match a hypothetical time lag for prescribing SSRIs following new depression symptoms.
